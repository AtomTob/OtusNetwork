...
2.2.2.2           1   FULL/DR         00:00:38    10.53.0.2       GigabitEthernet0/1

R2#sh ip ospf neighbor 
Neighbor ID     Pri   State           Dead Time   Address         Interface
1.1.1.1           1   FULL/BDR        00:00:31    10.53.0.1       GigabitEthernet0/1
```
...
Так как маршрутизатор R2 имеет более высокий идентификатор - 2.2.2.2. <br>
