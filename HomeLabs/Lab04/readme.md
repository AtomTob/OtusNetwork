...
![alt-текст](https://github.com/AtomTob/OtusNetwork/blob/main/HomeLabs/Lab04/files/ipv6_sub.png?raw=true)

Согласно общей структуре, первые 48 бит отводится под префикс глобальной идентификации, следующие 16 бит - под идентификатор сети

2001:db8:acad_0000::/64

##### ИТОГ

Идентификатор подсети - 0000 (или просто 0).
